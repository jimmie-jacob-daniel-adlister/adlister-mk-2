...
//        DaoFactory.getUsersDao().insert(daniel);
        User user=DaoFactory.getUsersDao().findByUsername("jimmie");
        System.out.println(user.getUsername());
//        Ad ad = new Ad(1, "Chair for sale!", "Used leather chair, still in good shape", 49.99);
...
//        DaoFactory.getCommentsDao().addComment(comment);
        ...
        PostCategories categories = new PostCategories(1, 1);
        DaoFactory.getPostsCategoriesDao().insert(categories);
